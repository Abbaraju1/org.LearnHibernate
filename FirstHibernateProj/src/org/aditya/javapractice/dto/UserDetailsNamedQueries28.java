...
*/
@NamedNativeQuery(name="UserDetails.byName", query="select * from USER_DETAILS_NamedQueries where userName = ?", resultClass=UserDetailsNamedQueries28.class)
...
public class UserDetailsNamedQueries28 {
